# Stored Prodedures (Procedimientos amacenados) en Transct-SQL (SQL SERVER)

1. Fundamentos

- ¿Qué es un Stored Procedure?

Un **Stored Procedure (SP)** es un bloque de codigo SQL guardado dentro de la BD que puede ejecutarse cuando se necesite. Es decir es un **OBJETO DE LA BD** 
...
2. Mejor Rendimiento 
3. Mayor seguridad
4. Centralización de logico de negocio 
...
5. Parámetros en Stored Prodedures

Los Parametros permite enviar datos al procedimiento 
...
Los parametro PUTPUT devuelven valores al usuario 
```sql
...
4. CASE 
Este sirve para evaluar condiciones con un switch o un if multiple 
```sql
...
5. Try ... Catch
 manejo de errores o exepciones en tiempo de ejecución y manejar lo que sucede cuando ocurre
...
-- TRANSACCION ➡️ begin transacction ➡️ commit Rollback
```sql
